...
export class VerProdutosComponent {
  ...
  constructor() {
    this.products = [
      { name: 'Produto 1', description: 'Descrição do produto 1Descrição do produto 1Descrição do produto 1Descrição do produto 1Descrição do produto 1Descrição do produto 1Descrição do produto 1Descrição do produto 1Descrição do produto 1', price: 10.00 },
